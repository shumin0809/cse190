...
import com.cse190.petcafe.ui.ActivityDialog;
...
public class PrivateChatManagerImpl extends QBMessageListenerImpl<QBPrivateChat> implements ChatManager, QBPrivateChatManagerListener {
    ...
    private ActivityDialog chatActivity;

    private QBPrivateChatManager privateChatManager;
    private QBPrivateChat privateChat;

    public PrivateChatManagerImpl(ActivityDialog chatActivity, Integer opponentID) {
        this.chatActivity = chatActivity;

        QBChatService service = QBChatService.getInstance();
        privateChatManager = service.getPrivateChatManager();
